export const headshotUrl = "/headshot.webp";
...
export const projects = [
  {
    ...
    url: "https://github.com/JuiceArb/JuiceArb",
    updated: "2026",
  },
  {
    name: "Roots",
    ...
    longDescription:
      "Led development of a comprehensive financial platform integrating budgeting, investing, and credit services. Won Best Financial Hack. Built an AI-driven investment recommendations dashboard using Flask and PostgreSQL, aiming to democratize access to personalized financial planning tools.",
    language: "Python",
  ...
  },
  {
    ...
    longDescription:
      "Developed a machine learning model for stock investment forecasts utilizing natural language processing on financial news sentiment. Applied VADER and NLTK toolkits for robust sentiment analysis, and constructed a scalable data ingestion pipeline to feed the scikit-learn predictive models.",
    language: "Python",
